...
<body>
	<div class="container">
		<div class="table-container">
			<h3>VELVETVIBE</h3>
		<h4 class="text-center">Services Details</h4>
			<br>
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="editServiceVelvetvibe.jsp?id=<%=service.getServicevv_id()%>"
								class="btn btn-custom btn-sm btn-action"><i class="bi bi-pencil"></i></a>
							<a href="deleteServiceVelvetvibe.jsp?id=<%=service.getServicevv_id()%>"
